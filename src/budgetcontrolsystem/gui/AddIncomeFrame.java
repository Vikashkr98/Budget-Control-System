 ...
 * @author aashi
 */
public class AddIncomeFrame extends javax.swing.JFrame {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        try{
            ...
            incomePojo obj = new incomePojo(username, Date,amountt,category,comment,income);
            boolean result = incomeDao.addIncome(obj);
            reportPojo ob = new reportPojo(username,Date,amountt,category,comment,income);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddIncomeFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
