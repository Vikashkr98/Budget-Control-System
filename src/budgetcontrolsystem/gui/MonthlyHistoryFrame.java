 ...
 * @author aashi
 */
public class MonthlyHistoryFrame extends javax.swing.JFrame {

    /**
     * Creates new form MonthlyHistoryFrame
     */
    public MonthlyHistoryFrame() {
        initComponents();this.setLocationRelativeTo(null);
        lblUsername.setText("Hello "+userProfile.getUsername());
        setTitle("Monthly History Frame");
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Username", "Date", "Amount", "Category", "Comment"
            }
        ) {
        ...
        jLabel1.setText("Monthly Record");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MonthlyHistoryFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MonthlyHistoryFrame().setVisible(true);
            }
        });
    }
